...
if (isset($_POST['upload_product']) && $_POST['upload_product'] == 'Submit') {
    if(in_array($fileType, $allowTypes)){
        ...
        if(move_uploaded_file($_FILES["file"]["tmp_name"], $targetFilePath)){
            ...
            // prodName,image, upload_date, category, size, gender, price, description, item_status, seller
            // '$prodName','$fileName', NOW(), '$category','$size', '$gender', '$price', '$description', '$status' ,'$username'
            ...
            if($insert){
                ...
                $statusMsg = "File upload failed, please try again.".$fileName."was not found";
            } 
        }else{
